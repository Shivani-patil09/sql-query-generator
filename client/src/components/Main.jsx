  ...
  return (
    <div className="grid grid-cols-2 border border-zinc-500 min-h-screen max-w-full rounded-2xl m-2 p-4">
      ...
      <div className="flex flex-col">
        <label
          htmlFor="message"
          className="block p-1 m-2 text-sm font-medium text-zinc-50 dark:text-white"
        >
          ...
          <button
            ...
            className={`h-10 w-3/5 min-w-fit rounded-lg ${
              !queryGenerated
                ...
                : "bg-gradient-to-t from-sky-400 via-45% via-sky-400/40 to-100% hover:bg-gradient-to-b from-sky-400 via-45% via-sky-400/40 to-100% border-sky-900 border-2 hover:opacity-80"
            }`}
